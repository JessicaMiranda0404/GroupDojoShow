...
class ShowManager(models.Manager):
    def basic_validator(self, post_data):
        ...
        if len(post_data['title']) < 2:
            errors['title'] = 'The show title must have at least 2 characters'
...
class Show(models.Model):
    ...
    created_by_user = models.ForeignKey(User, related_name = 'created_shows', on_delete = models.CASCADE)
    added_users = models.ManyToManyField(User, related_name = 'added_shows')
